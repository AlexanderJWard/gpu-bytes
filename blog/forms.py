...
class GPUForm(forms.ModelForm):
    ...
    class Meta:
        model = GPU
        fields = ('name', 'gpu_brand', 'image', 'date_released', 'content', 'sourced_from', 'specs', 'memory_size', 'memory_type', 'base_clock', 'boost_clock', 'status')  # noqa
...
class PostForm(forms.ModelForm):
    ...
    class Meta:
        model = Post
        fields = ('title', 'featured_image', 'content', 'sourced_from', 'excerpt', 'status')  # noqa
